                    ...
                    <div class="page-breadcrumb">
                        <div class="row">
                            <div class="col-7 align-self-center">
                                <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Data Mahasiswa</h3>
                   ...
                   <div class="table-responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a href="{{url('/hapus-mahasiswa')}}/{{$x->id}}" class="btn btn-danger btn2"><i class="bi bi-trash"></i></a></td>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form action="post-mahasiswa" method="post">
...
<div class="input-group mb-3">
    ...
    <input type="text" class="form-control" placeholder="No Tlp/WA" name="no_tlp" value="{{old('no_tlp')}}">
</div>
<div class="input-group mb-3">
...
<div class="modal fade" id="edit-{{$e->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    <form action="{{url('/update-mahasiswa')}}/{{$e->id}}" method="post">
        <div class="modal-body">
            @csrf
            <div class="input-group mb-3">

              <input type="text" class="form-control" name="name" value="{{$e->name}}" readonly>
          </div>
          ...
          <div class="input-group mb-3">
            ...
            <input type="password" class="form-control" name="password" value="{{$e->password}}">
        </div>
        ...
        <div class="input-group mb-3">
         <input type="text" class="form-control" name="jurusan" value="{{$e->jurusan}}" readonly>
     </div>
     ...
     <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" name="angkatan" value="{{$e->angkatan}}" readonly>
    </div>

    <div class="input-group mb-3">

        <input type="text" class="form-control" placeholder="No Tlp/WA" name="no_tlp" value="{{$e->no_tlp}}" readonly>
    </div>

    <div class="input-group mb-3">

        <input type="text" class="form-control" placeholder="No Tlp/WA" name="ket" value="{{$e->ket}}" readonly>
    </div>
