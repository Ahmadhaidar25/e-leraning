                ...
                <div class="scroll-sidebar" data-sidebarbg="skin6">
                    ...
                    <nav class="sidebar-nav">
                        ...
                        <div class="page-breadcrumb">
                         ...
                         <div class="row">
                                    ...
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#materi">
                                            ...
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#video">
                                                ...
                                                &nbsp;
                                                <a href="{{url('materi-if')}}" class="btn btn-success">Lihat Materi</a>
                            ...
                            <!-- ============================================================== -->
                            @if (Str::length(Auth::guard('baak')->user()) > 0)
                            <footer class="footer text-center text-muted" style="margin-top: 400px;">
                    ...
                    <div class="modal fade" id="materi" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog modal-dialog-centered">
                        ...
                        <form method="POST" action="{{url('post-materi-if')}}" enctype="multipart/form-data">
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header bg-primary">
                ...
                <form action="{{url('post-link-if')}}" method="post" enctype="multipart/form-data">
                    <div class="modal-body">
                        @csrf
