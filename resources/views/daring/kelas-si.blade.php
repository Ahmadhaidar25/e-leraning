...
<body>
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#materi">
                                                    ...
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#video">
                                                        ...
                                                        &nbsp;
                                                    <a href="{{url('materi-si')}}" class="btn btn-success">Lihat Materi</a>
    ...
    <div class="modal fade" id="materi" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        ...
        <form action="{{url('post-materi-si')}}" method="post" enctype="multipart/form-data">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        ...
        <form action="{{url('post-link-si')}}" method="post">
        <div class="modal-body">
           @csrf
