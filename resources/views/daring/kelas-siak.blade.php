            ...
            <aside class="left-sidebar" data-sidebarbg="skin6">
                ...
                <div class="scroll-sidebar" data-sidebarbg="skin6">
                                ...
                                <div class="row">
                                        ...
                                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#materi">
                                                    <i class="bi bi-cloud-upload"></i>&nbsp;Materi</button>
                                                    &nbsp;
                                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#video">
                                                        <i class="bi bi-cloud-upload"></i>&nbsp;Video</button>
                                                    ...
                                                    <nav aria-label="breadcrumb">
                                                        <ol class="breadcrumb m-0 p-0">
                                                            <li class="breadcrumb-item">
                                                               <h3><a href="">{{$siak->nama_matkul}}</a></h3>
                                                           </li>
                                                       </ol>
                                                   </nav>
                                               </div>
                                   ...
                                   <div class="container-fluid">
                                     ...
                                     <div class="row mb-2">
                                        ...
                                        <div class="card text-center col-lg-12 shadow-lg p-3 mb-5 bg-body rounded">
                                          <div class="card-header">


                                            <a href="" class="btn btn-danger btn2" style="float: right;">Hapus</a>
                                            &nbsp;&nbsp;
                                        ...
                                        <br>
                                        <div class="card-header">
                                            <h2 style="float: left;">Deskripsi</h2>
                                            ...
                                            <div class="container">
                                             ...
                                             <div class="col-6">
                                                <div class="p-3">
                                                    ...
                                                    <div id="tutorial-pdf-responsive" class="custom3">
                                                      <div class="custom4">
                                                       <video controls>
                    ...
                    <div class="card-footer">
                        <p style="float: left;"><a href="" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Komentar</a></p>
                    </div>
                </div>
