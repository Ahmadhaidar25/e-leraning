                             ...
                             <div class="table-responsive">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="" class="btn btn-warning text-white" data-bs-toggle="modal" data-bs-target="#edit"><i class="bi bi-pencil-square"></i></a></td>

                                        <td><a href="" class="btn btn-danger text-white" data-bs-toggle="modal" data-bs-target="#edit"><i class="bi bi-trash"></i></a></td>
                                    </tr>
            ...
            <form action="post-mahasiswa" method="post">
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3">
                      ...
                      <input type="text" class="form-control" name="nama_matkul" placeholder="Nama Matkul" value="{{old('nama_matkul')}}">
                  </div>
    ...
    <form action="{{url('/update-matkul')}}" method="post">
        ...
        <div class="input-group mb-3">
         <select class="form-control" name="jurusan">
             ...
             <option value="sistem infromasi">Sisitem Infromasi</option>
     ...
     <div class="input-group mb-3">
        ...
        <input type="text" class="form-control" name="angkatan" value="" readonly>
    </div>

    <div class="input-group mb-3">

        <input type="text" class="form-control" placeholder="No Tlp/WA" name="no_tlp" value="" readonly>
    </div>

    <div class="input-group mb-3">

        <input type="text" class="form-control" placeholder="No Tlp/WA" name="ket" readonly>
    </div>
