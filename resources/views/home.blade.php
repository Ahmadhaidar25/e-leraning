      ...
      <div class="row gy-5">
        <div class="col-6">
            <div class="p-3 ">
                ...
                <h1>Selamat Datang,&nbsp;{{Auth::guard('mahasiswa')->user()->name}}<span id="typed" class="typed"></span></h1>
                @endif

                @if (Str::length(Auth::guard('dosen')->user()) > 0)
                <h1>Selamat Datang,&nbsp;{{Auth::guard('dosen')->user()->name}}<span id="typed" class="typed"></span></h1>
                @endif

                @if (Str::length(Auth::guard('baak')->user()) > 0)
                <h1>Selamat Datang,&nbsp;{{Auth::guard('baak')->user()->name}}<span id="typed" class="typed"></span></h1>
                @endif
            </div>
...
<div class="container-fluid">
    ...
    <div class="card border-right shadow p-3 mb-5 bg-body rounded bg-primary">
        <div class="card-body ">
           <div class="d-flex d-lg-flex d-md-block align-items-center">
            <div>
                <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium"><sup class="set-doller"></sup></h2>
                <a href="" data-bs-toggle="modal" data-bs-target="#presensi">
                    <h3 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Presensi
                    </h3>
                </a>
            </div>
...
&nbsp;
<div class="card border-right shadow p-3 mb-5 bg-body rounded bg-primary text-white">
    <div class="card-body">
        <div class="d-flex d-lg-flex d-md-block align-items-center">
            <div>
                <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium"><sup class="set-doller"></sup></h2>
                <a href="" data-bs-toggle="modal" data-bs-target="#tugas">
                    <h3 class="text-muted font-weight-normal mb-0 w-100 text-truncate text-white">Tugas
                    </h3>
                </a>
            </div>
            <div class="ml-auto mt-md-3 mt-lg-0">
...
<div class="container-fluid">
    ...
    <div class="card border-right shadow p-3 mb-5 bg-body rounded">
        <div class="card-body">
           <div class="d-flex d-lg-flex d-md-block align-items-center">
            <div>
                <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium"><sup
                    class="set-doller"></sup>{{$dosen}}</h2>
                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Jumlah Dosen
                    </h6>
                </div>
                <div class="ml-auto mt-md-3 mt-lg-0">
                    <span class="opacity-7 text-muted"><i data-feather="user"></i></span>
    ...
    <div class="card border-right shadow p-3 mb-5 bg-body rounded">
        <div class="card-body">
            <div class="d-flex d-lg-flex d-md-block align-items-center">
                <div>
                    <h2 class="text-dark mb-1 w-100 text-truncate font-weight-medium"><sup
                        class="set-doller"></sup>{{$mhs}}</h2>
                        <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Jumlah Mahasiswa
                        </h6>
                    </div>
                    <div class="ml-auto mt-md-3 mt-lg-0">
                        <span class="opacity-7 text-muted"><i data-feather="user"></i></span>
...
<div class="modal fade" id="tugas" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Rekap Tugas</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
    </div>
    <div class="modal-body">
