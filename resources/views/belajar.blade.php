                ...
                <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="home"
                    ...
                    <ul aria-expanded="false" class="collapse first-level base-level-line">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="home"
                            ...
                            <ul aria-expanded="false" class="collapse first-level base-level-line">
                                <li class="sidebar-item"><a href="{{url('belajar')}}" class="sidebar-link"><span
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="card shadow-lg p-3 mb-5 bg-body rounded">
                          <div class="card-header">
                            ...
                            <div class="btn-group" role="group" style="float: right;" aria-label="Basic example">
                                <a href="{{url('/matkul/kirim-tugas')}}" class="btn btn-primary">Unggah Tugas</a>
                                &nbsp;
                                <a href="{{url('/matkul/kirim-presensi')}}" class="btn btn-primary">Presensi</a>
                        ...
                        <div class="card-body">
                            ...
                            <iframe src="{{asset('/materi')}}/{{$x->materi}}" width="600" height="600"></iframe>
                            <br><br>
                            <a href="" data-bs-toggle="modal" data-bs-target="#coment"><i class="bi bi-chat-dots"></i>&nbsp;Komentar</a>
                        </div>
